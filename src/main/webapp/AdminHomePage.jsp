...
<li><a href="DeleteCategory">Delete Category</a>
...
<li class="admin-panel"><a href=""><img alt="" src="Images/admin.png" style="width: 20;height: 20"></a></li>
</ul>
</div> -->
</div>
</body>
